...
# get teh IP address of this computer by name, and it takes the name of the computer 
# as a paramter 
'''
Why would we want to just hardcode the direct address?
if we want to access this one a different device, we woud have to change the name 
each time
'''
